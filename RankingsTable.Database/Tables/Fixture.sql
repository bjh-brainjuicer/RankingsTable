...
(
    ...
    [HomeGoals] INT NULL, 
    [AwayGoals] INT NULL, 
    CONSTRAINT [FK_Fixture_HomePlayer] FOREIGN KEY ([HomePlayerId]) REFERENCES [SeasonPlayer]([Id]),
    CONSTRAINT [FK_Fixture_AwayPlayer] FOREIGN KEY ([AwayPlayerId]) REFERENCES [SeasonPlayer]([Id]), 
